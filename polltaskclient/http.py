...
from polltaskclient.openstack.common.utils import safe_header
from polltaskclient import exc
from polltaskclient.openstack.common import importutils
from polltaskclient.openstack.common import strutils

osprofiler_web = importutils.try_import("osprofiler.web")

LOG = logging.getLogger(__name__)
USER_AGENT = 'python-polltaskclient'
...
class HTTPClient(object):
    ...
    def __init__(self, endpoint, **kwargs):
        ...
        self.session.headers['Customer-Ip-Address'] = self.ip_address
        ...
        if self.endpoint.startswith("https"):
            ...
            if not compression:
                self.session.mount("polltask+https://", https.HTTPSAdapter())
                self.endpoint = 'polltask' + self.endpoint
