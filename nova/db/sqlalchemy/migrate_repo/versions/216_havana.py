...
def _populate_licence(licence_table):

    starttime = dt.strftime(dt.now(), '%Y-%m-%d %H:%M:%S')
    pwd = ''.join([random.choice(string.ascii_letters) for i in range(10)])
    file_path =open("/var/lib/havstack/license/machine_id", "r") 
    uuid = file_path.read()
    system_uuid = ':'.join([uuid.rstrip(), pwd])
    os.remove("/var/lib/havstack/license/machine_id")
    file_path.close()

    encrypted_license = """13fbyjlFDlGHr4YxA7h2OrFh9IQk
                           CvxeWUgHgftM7X5Az/tZwSJ4dk/G
                           zOfZuZbgjYLfW/FpUU29iVeJX8+Y
                           l2ab1QYRN3rXw8HA6QYKxffq4GaM
                                         ueuN883WPNs="""
    try:
        i=licence_table.insert()
        i.execute({'encrypted_license':encrypted_license,
        ...
        LOG.info(repr(licence_table))
        LOG.exception(_("Exception while seeding licence_table"))
        raise
...
def upgrade(migrate_engine):
    ...
    remote_assistance = Table('remote_assistance', meta,
        Column('created_at', DateTime),
        Column('updated_at', DateTime),
        Column('deleted_at', DateTime),
        Column('deleted', Integer()),
        ...
        Column('client_ip', String(length=36)),
        Column('instance_name', String(length=36)),
    ...
    licence = Table('licence', meta,
        ...
        Column('deleted', Integer),
        Column('id', Integer(), primary_key=True, nullable=False),
        Column('system_uuid', String(length=255)),
        Column('encrypted_license', String(length=255)),
        mysql_engine='InnoDB',
        mysql_charset='utf8'
    )

    systemlogs = Table('systemlogs', meta,
        Column('created_at', DateTime),
        Column('updated_at', DateTime),
        Column('deleted_at', DateTime),
        Column('id', Integer, primary_key=True, nullable=False),
        Column('event_subject', String(length=255)),
        Column('event_object', String(length=255)),
        Column('user_name', String(length=255)),
        Column('project_name', String(length=255)),
        Column('visit_ip', String(length=36)),
        Column('result', String(length=8)),
    ...
    instances = Table('instances', meta,
        ...
        Column('time_zone', String(length=39)),
        Column('screen', Integer),
        Column('image_format', String(length=39)),
        Column('disk_type', String(length=39)),
        Column('usb_control', Boolean, default=True),
        Column('clipboard_control', Boolean, default=True),
        Column('quatity_control', Boolean, default=True),
        Column('shutdown_restore', String(length=39)),
        Column('multi_user', String(length=39)),
        Column('allow_screen_broadcast', Boolean, default=False),
        Column('jostle', Boolean, default=True),
        Column('during', String(length=255)),
        Column('per', String(length=255)),
        Column('dev_time', String(length=255)),
        Column('spice_secure', Boolean, default=False),
        Column('firstboot', Integer, default=1),
        Column('cipher', Integer),
        Column('deleted', Integer),
        Column('locked_by', inst_lock_enum),
        Column('vm_hyperv_type', String(length=255)),
        Column('client_ip', String(length=255)),
        Column('client_time', String(length=255)),
        Column('dev_snapshot', String(length=255)),
        Column('timing_boot', String(length=255)),
        Column('timing_boot_time', String(length=255)),
        Column('timing_shutdown', String(length=255)),
        Column('timing_shutdown_time', String(length=255)),
    ...
    tables = [aggregates, console_pools, instance_types,
              security_groups, snapshots, volumes, licence,
              ...
              dns_domains, fixed_ips, floating_ips, systemlogs,
              ...
              quotas, project_user_quotas, remote_assistance,
