...
class ComputeAPI(object):
    ...
    def dev_snapshot_create(self, ctxt, instance, name):
        instance_p = jsonutils.to_primitive(instance)
        version = '4.0'
        cctxt = self.router.by_instance(ctxt, instance).prepare(
                server=_compute_host(None, instance), version=version)
        return cctxt.cast(ctxt, 'dev_snapshot_create', instance=instance, name=name)

    def dev_snapshot_list(self, ctxt, instance):
        instance_p = jsonutils.to_primitive(instance)
        version = '4.0'
        cctxt = self.router.by_instance(ctxt, instance).prepare(
                server=_compute_host(None, instance), version=version)
        return cctxt.call(ctxt, 'dev_snapshot_list', instance=instance)

    def dev_snapshot_revert(self, ctxt, instance, name):
        instance_p = jsonutils.to_primitive(instance)
        version = '4.0'
        cctxt = self.router.by_instance(ctxt, instance).prepare(
                server=_compute_host(None, instance), version=version)
        return cctxt.cast(ctxt, 'dev_snapshot_revert', instance=instance, name=name)

    def dev_snapshot_delete(self, ctxt, instance, name):
        instance_p = jsonutils.to_primitive(instance)
        version = '4.0'
        cctxt = self.router.by_instance(ctxt, instance).prepare(
                server=_compute_host(None, instance), version=version)
        return cctxt.cast(ctxt, 'dev_snapshot_delete', instance=instance, name=name)

    def cdrom_list(self, ctxt, instance):
        instance_p = jsonutils.to_primitive(instance)
        version = '4.0'
        cctxt = self.router.by_instance(ctxt, instance).prepare(
                server=_compute_host(None, instance), version=version)
        #return cctxt.cast(ctxt, 'cdrom_list', instance=instance)
        return cctxt.call(ctxt, 'cdrom_list', instance=instance)

    def attach_cdrom(self, ctxt, instance, device, image_id):
        version = '4.0'
        timeout = 6000
        kwargs = {'instance':instance, 
                  ...
                  'image_id':image_id}
        cctxt = self.router.by_instance(ctxt, instance).prepare(
                server=_compute_host(None, instance), version=version, timeout=timeout)
        return cctxt.call(ctxt, 'attach_cdroms', instance=instance, device=device, image_id=image_id)
    ...
    def get_port(self, ctxt, instance, console_type):
        version = '4.0'
        cctxt = self.router.by_instance(ctxt, instance).prepare(
                server=_compute_host(None, instance), version=version)
        return cctxt.call(ctxt, 'get_port', 
                          instance=instance, console_type=console_type)
