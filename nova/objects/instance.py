...
class Instance(base.NovaPersistentObject, base.NovaObject,
    ...
    fields = {
        ...
        # New features,
        # New secondary personal name database instance
        'cipher': fields.IntegerField(nullable=True),
        'timing_boot': fields.StringField(nullable=True),
        'timing_boot_time': fields.StringField(nullable=True),
        'timing_shutdown': fields.StringField(nullable=True),
        'timing_shutdown_time': fields.StringField(nullable=True),
        'time_zone': fields.StringField(nullable=True),
        'screen': fields.IntegerField(nullable=True),
        'image_format':fields.StringField(nullable=True),
        'disk_type': fields.StringField(nullable=True),
        'usb_control': fields.BooleanField(default=False),
        'clipboard_control': fields.BooleanField(default=True),
        'quatity_control': fields.BooleanField(default=False),
        'shutdown_restore':fields.StringField(nullable=True),
        'multi_user':fields.StringField(nullable=True),
        'allow_screen_broadcast':fields.BooleanField(default=False),
        'jostle': fields.BooleanField(default=False),
        'firstboot': fields.IntegerField(default=1),
        'during': fields.StringField(nullable=True),
        'per': fields.StringField(nullable=True),
        'dev_time': fields.StringField(nullable=True),
        'spice_secure': fields.BooleanField(default=False),
        'client_ip': fields.StringField(nullable=True),
        'client_time': fields.StringField(nullable=True),
        'vm_hyperv_type': fields.StringField(nullable=True),
        ...
        'info_cache': fields.ObjectField('InstanceInfoCache',
                                         nullable=True),
        'dev_snapshot':fields.StringField(nullable=True),
