    ...
    'properties': {
        'server': {
            ...
            'properties': {
                ...
                'cipher':parameter_types.cipher,
                'pool':parameter_types.pool,
                ...
                'terminal': {
                    ...
                    'items': {
                        ...
                        'properties':{
                            ...
                            'usb_control':{'type':'boolean'},
                            'clipboard_control':{'type':'boolean'},
                            'quatity_control':{'type':'boolean'} ,
                            'shutdown_restore':{'type':'string'},
                            'multi_user':{'type':'string'},
                            'allow_screen_broadcast':{'type':'boolean'},
                            'jostle':{'type':'boolean'},
                            'during':{'type':'string'},
                            'spice_secure':{'type':'boolean'},
                            'per':{'type':['string', 'null']},
                            'dev_time':{'type':['string', 'null']},
                            'vm_user':{'type':['string', 'null']}
                        },
    ...
    'properties': {
        'server': {
            ...
            'properties': {
                ...
                'project': parameter_types.project,
                'terminal': {
                    'type': ['array', 'null'],
                    'items': {
                        'type':'object',
