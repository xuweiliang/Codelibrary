...
//    console.info("id ==============", getURLParameter('host'))
//    host = getURLParameter('host')
//    var passwd = null
//    $.ajax({
//        type:"GET",
//        url :"http://"+host+"/dashboard/passwd/?instance_id="+id,
//        dataType:"jsonp",
//        jsonp:"callback",
//        jsonpCallback:"passwd",
...
//                      alert('error');
	...
	app.run({
		...
		'busFileServerBaseUrl': 'https://'+getURLParameter('host')+'/fileserver/',
		'layout': 'es',
		'clientOffset': {
			'x': 0,
			'y': 0
        ...
        $("#sendCtrlAltDelButton").click(function(){
            alert("sendCtrlAltDelButton!")
            app.sendShortcut(0, 'keydown')
        }); 
}
