...
class IndexView(tables.DataTableView):
    ...
    def get_data(self):
        ...
        try:
            instances, self._more, self._prev= api.nova.server_paging(
...
class SerialConsoleView(generic.TemplateView):
    template_name = 'admin/instances/serial_console.html'
...
class RebuildView(forms.ModalFormView):
    ...
    template_name = 'admin/instances/rebuild.html'
    success_url = reverse_lazy('horizon:admin:instances:index')
...
class DecryptPasswordView(forms.ModalFormView):
    ...
    template_name = 'admin/instances/decryptpassword.html'
    success_url = reverse_lazy('horizon:admin:instances:index')
...
class AttachInterfaceView(forms.ModalFormView):
    ...
    template_name = 'admin/instances/attach_interface.html'
    ...
    def get_initial(self):
        ...
        submit_url = "horizon:admin:instances:attach_interface"
...
class AttachVolumeView(forms.ModalFormView):
    ...
    template_name = 'admin/instances/attach_volume.html'
    ...
    def get_initial(self):
        args = {'instance_id': self.kwargs['instance_id']}
        submit_url = "horizon:admin:instances:attach_volume"
        self.submit_url = reverse(submit_url, kwargs=args)
        try:
...
class DetachVolumeView(forms.ModalFormView):
    ...
    template_name = 'admin/instances/detach_volume.html'
    ...
    def get_initial(self):
        args = {'instance_id': self.kwargs['instance_id']}
        submit_url = "horizon:admin:instances:detach_volume"
        self.submit_url = reverse(submit_url, kwargs=args)
        return {"instance_id": self.kwargs["instance_id"]}
...
class DetachInterfaceView(forms.ModalFormView):
    ...
    template_name = 'admin/instances/detach_interface.html'
    ...
    def get_initial(self):
        args = {"instance_id": self.kwargs["instance_id"]}
        submit_url = "horizon:admin:instances:detach_interface"
        self.submit_url = reverse(submit_url, kwargs=args)
        return args

class ReallocationView(forms.ModalFormView):
    form_class = project_forms.ReallocationInstanceForm
    template_name = 'admin/instances/reallocation.html'
...
class CreateDevsnapshotView(forms.ModalFormView):
    ...
    template_name = 'admin/instances/create_dev_sanpshot.html'
    context_object_name = 'instance'
    success_url = reverse_lazy('horizon:admin:instances:index')
...
class DeleteDevsnapshotView(forms.ModalFormView):
    ...
    template_name = 'admin/instances/delete_dev_sanpshot.html'
    context_object_name = 'instance'
    success_url = reverse_lazy('horizon:admin:instances:index')
...
class SetDevsnapshotView(forms.ModalFormView):
    ...
    template_name = 'admin/instances/set_dev_sanpshot.html'
    context_object_name = 'instance'
    success_url = reverse_lazy('horizon:admin:instances:index')
...
class RevertDevsnapshotView(forms.ModalFormView):
    ...
    template_name = 'admin/instances/revert_dev_sanpshot.html'
    context_object_name = 'instance'
    success_url = reverse_lazy('horizon:admin:instances:index')
...
class CDromView(forms.ModalFormView):
    ...
    template_name = 'admin/instances/cdrom.html'
    success_url = reverse_lazy("horizon:admin:instances:index")
