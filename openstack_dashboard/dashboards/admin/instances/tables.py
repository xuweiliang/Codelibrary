...
from openstack_dashboard.dashboards.admin.instances.workflows \
...
class TimingBoot(tables.LinkAction):
    ...
    url = "horizon:admin:instances:timingboot"
...
class TimingShutdown(tables.LinkAction):
    ...
    url = "horizon:admin:instances:timingshutdown"
    classes = ("ajax-modal", "btn-launch")
    ajax = True
...
class UpdateInstanceResourceLink(tables.LinkAction):
    ...
    url = "horizon:admin:instances:resource"
    classes = ("ajax-modal", "btn-launch")
    ajax = True
...
class DeleteInstance(policy.PolicyTargetMixin, tables.DeleteAction):
    ...
    def action(self, request, obj_id):
        ...
        api.nova.systemlogs_create(request, '-',\
                      record_action.DELETEINSTANCE,\
                      result=False, detail=_("Delete Instance"))
...
class LaunchLink(tables.LinkAction):
    ...
    url = "horizon:admin:instances:launch"
    classes = ("ajax-modal", "btn-launch")
    icon = "cloud-upload"
...
class LaunchLinkNG(LaunchLink):
    name = "launch-ng"
    url = "horizon:admin:instances:index"
    ajax = False
    classes = ("btn-launch", )
...
class ResizeLink(policy.PolicyTargetMixin, tables.LinkAction):
    name = "resize"
    verbose_name = _("Resize Instance")
    url = "horizon:admin:instances:resize"
...
class RebuildInstance(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:admin:instances:rebuild"
...
class DecryptInstancePassword(tables.LinkAction):
    ...
    url = "horizon:admin:instances:decryptpassword"
...
class ReallocationInstance(tables.LinkAction):
    ...
    url = "horizon:admin:instances:reallocation"
    classes = ("ajax-modal",)
...
class EditCDRom(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:admin:instances:editcdrom"
    classes = ("ajax-modal",)
    icon = "camera"
...
class AttachVolume(tables.LinkAction):
    ...
    url = "horizon:admin:instances:attach_volume"
    classes = ("ajax-modal",)
...
class DetachVolume(AttachVolume):
    ...
    url = "horizon:admin:instances:detach_volume"
...
class AttachInterface(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:admin:instances:attach_interface"
...
class DetachInterface(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    classes = ("btn-confirm", "ajax-modal")
    url = "horizon:admin:instances:detach_interface"
...
class EditTimingBoot(policy.PolicyTargetMixin, tables.LinkAction):
    name = "settimingboot"
    verbose_name = _("Timing Boot")
    url = "horizon:admin:instances:settimingboot"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class EditTimingShutdown(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    verbose_name = _("Timing Shutdown")
    url = "horizon:admin:instances:settimingshutdown"
    classes = ("ajax-modal",)
    icon = "pencil"
...
def get_size(instance):
    if hasattr(instance, "full_flavor"):
        template_name = 'admin/instances/_instance_flavor.html'
...
#                            attrs={'data-type': 'timesince'})
    ...
    class Meta(object):
        ...
        row_actions = (StartInstance, ConfirmResize, RevertResize, 
                       ReallocationInstance, MigrateInstance, 
                       LiveMigrateInstance, CreateSnapshot, 
                       SimpleAssociateIP, AssociateIP, 
                       SimpleDisassociateIP, EditInstance, EditCDRom,
