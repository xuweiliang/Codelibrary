...
class IndexView(tables.DataTableView):
    ...
    def get_data(self):
        ...
        #SystemName = ['nova','admin', 'glance','cinder','ceilometer','swift','neutron','AdminShadow']
        return [u for u in users if u.name != 'admin']
...
class UpdateView(forms.ModalFormView):
    ...
    submit_url = "horizon:admin:users:update"
...
class CreateView(forms.ModalFormView):
    ...
    submit_url = reverse_lazy("horizon:admin:users:create")
    success_url = reverse_lazy('horizon:admin:users:index')
...
class DetailView(views.HorizonTemplateView):
    ...
    def get_redirect_url(self):
        return reverse('horizon:admin:users:index')
...
class ChangePasswordView(forms.ModalFormView):
    ...
    submit_url = "horizon:admin:users:change_password"
    submit_label = _("Save")
    success_url = reverse_lazy('horizon:admin:users:index')
