...
class AddComputeHost(forms.ModalFormView):
    form_class = project_forms.AddComputeHostForm
    template_name = 'admin/aggregates/compute/add_host.html'
    success_url = reverse_lazy("horizon:admin:aggregates:index")

class EvacuateHostView(forms.ModalFormView):
    form_class = project_forms.EvacuateHostForm
    template_name = 'admin/aggregates/compute/evacuate_host.html'
