...
from openstack_dashboard.dashboards.admin.vgpu import console
LOG = logging.getLogger(__name__)

class OverviewTab(tabs.Tab):
    name = _("Overview")
    slug = "overview"
    template_name = ("admin/vgpu/"
...
class LogTab(tabs.Tab):
    name = _("Log")
    slug = "log"
    template_name = "admin/vgpu/_detail_log.html"
    preload = False
...
class ConsoleTab(tabs.Tab):
    name = _("Console")
    slug = "console"
    template_name = "admin/vgpu/_detail_console.html"
    preload = False
    ...
    def get_context_data(self, request):
        ...
        try:
            ...
            if console_type == "SERIAL":
                console_url = reverse('horizon:admin:vgpu:serial',
                                      args=[instance.id])
...
class AuditTab(tabs.TableTab):
    ...
    template_name = "admin/vgpu/_detail_audit.html"
    preload = False
...
class DevsnapshotTab(tabs.TableTab):
    ...
    template_name = "admin/vgpu/_detail_dev_sanpshot.html"
    preload = False
