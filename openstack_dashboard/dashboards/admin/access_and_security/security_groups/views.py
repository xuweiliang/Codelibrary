...
from openstack_dashboard.dashboards.admin.access_and_security.\
...
class DetailView(tables.DataTableView):
    ...
    template_name = 'admin/access_and_security/security_groups/detail.html'
    ...
    def _get_data(self):
        ...
        try:
            ...
            redirect = reverse('horizon:admin:access_and_security:index')
...
class UpdateView(forms.ModalFormView):
    ...
    template_name = 'admin/access_and_security/security_groups/update.html'
    submit_label = _("Edit Security Group")
    submit_url = "horizon:admin:access_and_security:security_groups:update"
    success_url = reverse_lazy('horizon:admin:access_and_security:index')
...
class AddRuleView(forms.ModalFormView):
    ...
    template_name = 'admin/access_and_security/security_groups/add_rule.html'
    submit_label = _("Add")
    submit_url = "horizon:admin:access_and_security:security_groups:add_rule"
    url = "horizon:admin:access_and_security:security_groups:detail"
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'admin/access_and_security/security_groups/create.html'
    submit_label = _("Create Security Group")
    submit_url = reverse_lazy(
        "horizon:admin:access_and_security:security_groups:create")
    success_url = reverse_lazy('horizon:admin:access_and_security:index')
