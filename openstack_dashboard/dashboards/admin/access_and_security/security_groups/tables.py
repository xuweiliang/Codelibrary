...
class CreateGroup(tables.LinkAction):
    ...
    url = "horizon:admin:access_and_security:security_groups:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class EditGroup(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:admin:access_and_security:security_groups:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class CreateRule(tables.LinkAction):
    ...
    url = "horizon:admin:access_and_security:security_groups:add_rule"
    classes = ("ajax-modal",)
    icon = "plus"
...
class DeleteRule(tables.DeleteAction):
    ...
    def get_success_url(self, request):
        ...
        return reverse("horizon:admin:access_and_security:"
