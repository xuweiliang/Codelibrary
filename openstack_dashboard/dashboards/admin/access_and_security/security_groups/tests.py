...
SG_CREATE_URL = reverse('horizon:admin:access_and_security:'
                        'security_groups:create')

SG_VIEW_PATH = 'horizon:admin:access_and_security:security_groups:%s'
SG_DETAIL_VIEW = SG_VIEW_PATH % 'detail'
SG_UPDATE_VIEW = SG_VIEW_PATH % 'update'
SG_ADD_RULE_VIEW = SG_VIEW_PATH % 'add_rule'

SG_TEMPLATE_PATH = 'admin/access_and_security/security_groups/%s'
