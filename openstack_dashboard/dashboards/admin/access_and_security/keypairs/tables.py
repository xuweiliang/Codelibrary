...
class ImportKeyPair(tables.LinkAction):
    ...
    url = "horizon:admin:access_and_security:keypairs:import"
    classes = ("ajax-modal",)
    icon = "upload"
...
class CreateKeyPair(tables.LinkAction):
    ...
    url = "horizon:admin:access_and_security:keypairs:create"
    classes = ("ajax-modal",)
    icon = "plus"
    policy_rules = (("compute", "compute_extension:keypairs:create"),)
...
class KeypairsTable(tables.DataTable):
    detail_link = "horizon:admin:access_and_security:keypairs:detail"
