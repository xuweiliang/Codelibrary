...
INDEX_VIEW_URL = reverse('horizon:admin:access_and_security:index')
...
class KeyPairViewTests(test.TestCase):
    ...
    def test_create_keypair_get(self):
        res = self.client.get(
            reverse('horizon:admin:access_and_security:keypairs:create'))
        self.assertTemplateUsed(
            res, 'admin/access_and_security/keypairs/create.html')

    def test_download_keypair_get(self):
        keypair_name = "keypair"
        context = {'keypair_name': keypair_name}
        url = reverse('horizon:admin:access_and_security:keypairs:download',
                      kwargs={'keypair_name': keypair_name})
        res = self.client.get(url, context)
        self.assertTemplateUsed(
            res, 'admin/access_and_security/keypairs/download.html')
    ...
    def test_generate_keypair_get(self):
        ...
        url = reverse('horizon:admin:access_and_security:keypairs:generate',
    ...
    def test_keypair_detail_get(self):
        ...
        context = {'keypair_name': keypair.name}
        url = reverse('horizon:admin:access_and_security:keypairs:detail',
                      kwargs={'keypair_name': keypair.name})
        res = self.client.get(url, context)
    ...
    def test_import_keypair(self):
        ...
        url = reverse('horizon:admin:access_and_security:keypairs:import')
    ...
    def test_generate_keypair_exception(self):
        ...
        self.assertRedirectsNoFollow(
            res, reverse('horizon:admin:access_and_security:index'))
