...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'admin/access_and_security/keypairs/create.html'
    submit_label = _("Create Key Pair")
    submit_url = reverse_lazy(
        "horizon:admin:access_and_security:keypairs:create")
    success_url = 'horizon:admin:access_and_security:keypairs:download'
    page_title = _("Create Key Pair")
    cancel_url = reverse_lazy(
        "horizon:admin:access_and_security:index")
...
class ImportView(forms.ModalFormView):
    ...
    template_name = 'admin/access_and_security/keypairs/import.html'
    submit_label = _("Import Key Pair")
    submit_url = reverse_lazy(
        "horizon:admin:access_and_security:keypairs:import")
...
class DetailView(views.HorizonTemplateView):
    template_name = 'admin/access_and_security/keypairs/detail.html'
...
class DownloadView(views.HorizonTemplateView):
    template_name = 'admin/access_and_security/keypairs/download.html'
