...
from openstack_dashboard.dashboards.admin.access_and_security.\
    download_sql import urls as download_sql_urls
from openstack_dashboard.dashboards.admin.access_and_security import views
...
urlpatterns = [
    ...
    url(r'download_sql/', include(download_sql_urls, namespace='download_sql')),
]
