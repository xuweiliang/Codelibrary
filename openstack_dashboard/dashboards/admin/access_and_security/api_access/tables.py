...
class DownloadEC2(tables.LinkAction):
    ...
    icon = "download"
    url = "horizon:admin:access_and_security:api_access:ec2"
...
class DownloadOpenRC(tables.LinkAction):
    ...
    icon = "download"
    url = "horizon:admin:access_and_security:api_access:openrc"
...
class DownloadOpenRCv2(tables.LinkAction):
    ...
    icon = "download"
    url = "horizon:admin:access_and_security:api_access:openrcv2"
...
class ViewCredentials(tables.LinkAction):
    ...
    classes = ("ajax-modal", )
    icon = "eye"
    url = "horizon:admin:access_and_security:api_access:view_credentials"
