...
API_URL = "horizon:admin:access_and_security:api_access"
...
class APIAccessTests(test.TestCase):
    ...
    def test_openrcv2_credentials(self):
        ...
        self.assertEqual(res.status_code, 200)
        openrc = 'admin/access_and_security/api_access/openrc_v2.sh.template'
    ...
    def test_openrc_credentials(self):
        ...
        self.assertEqual(res.status_code, 200)
        openrc = 'admin/access_and_security/api_access/openrc.sh.template'
        self.assertTemplateUsed(res, openrc)
        name = 'export OS_USERNAME="{}"'.format(self.request.user.username)
    ...
    def test_credential_api(self):
        ...
        self.assertEqual(res.status_code, 200)
        credentials = 'admin/access_and_security/api_access/credentials.html'
