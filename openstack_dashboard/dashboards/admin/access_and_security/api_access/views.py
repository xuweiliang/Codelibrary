...
from openstack_dashboard.dashboards.admin.access_and_security.api_access \
...
def download_ec2_bundle(request):
    ...
    template = 'admin/access_and_security/api_access/ec2rc.sh.template'
    try:
...
def download_rc_file_v2(request):
    template = 'admin/access_and_security/api_access/openrc_v2.sh.template'
...
class CredentialsView(forms.ModalFormMixin, views.HorizonTemplateView):
    template_name = 'admin/access_and_security/api_access/credentials.html'
...
class RecreateCredentialsView(forms.ModalFormView):
    ...
    template_name = \
        'admin/access_and_security/api_access/recreate_credentials.html'
    submit_label = _("Recreate EC2 Credentials")
    submit_url = reverse_lazy(
        "horizon:admin:access_and_security:api_access:recreate_credentials")
