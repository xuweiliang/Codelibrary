...
class CreateBackupView(forms.ModalFormView):
    ...
    template_name = 'admin/volumes/backups/create_backup.html'
    submit_label = _("Create Volume Backup")
    submit_url = "horizon:admin:volumes:volumes:create_backup"
    success_url = reverse_lazy("horizon:admin:volumes:backups_tab")
...
class RestoreBackupView(forms.ModalFormView):
    ...
    template_name = 'admin/volumes/backups/restore_backup.html'
    submit_label = _("Restore Backup to Volume")
    submit_url = "horizon:admin:volumes:backups:restore"
