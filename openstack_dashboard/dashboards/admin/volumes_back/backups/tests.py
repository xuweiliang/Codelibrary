...
VOLUME_BACKUPS_TAB_URL = reverse('horizon:admin:volumes:backups_tab')
...
class VolumeBackupsViewTests(test.TestCase):
    ...
    def test_create_backup_post(self):
        ...
        url = reverse('horizon:admin:volumes:volumes:create_backup',
                      args=[volume.id])
    ...
    def test_volume_backup_detail_get(self):
        ...
        url = reverse('horizon:admin:volumes:backups:detail',
                      args=[backup.id])
    ...
    def test_restore_backup(self):
        ...
        url = reverse('horizon:admin:volumes:backups:restore',
                      args=[backup.id])
