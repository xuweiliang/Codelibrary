...
VOLUME_INDEX_URL = reverse('horizon:admin:volumes:index')
VOLUME_VOLUMES_TAB_URL = urlunquote(reverse(
    'horizon:admin:volumes:volumes_tab'))
...
class VolumeViewTests(test.ResetImageAPIVersionMixin, test.TestCase):
    ...
    def test_create_volume(self):
        ...
        url = reverse('horizon:admin:volumes:volumes:create')
    ...
    def test_edit_attachments(self):
        ...
        url = reverse('horizon:admin:volumes:volumes:attach',
                      args=[volume.id])
    ...
    def test_create_snapshot_button_attributes(self):
        ...
        self.assertEqual('horizon:admin:volumes:volumes:create_snapshot',
                         snapshot_action.url)
    ...
    def test_create_button_attributes(self):
        ...
        self.assertEqual('horizon:admin:volumes:volumes:create',
                         create_action.url)
    ...
    def test_detail_view(self):
        ...
        url = reverse('horizon:admin:volumes:volumes:detail',
                      args=[volume.id])
        res = self.client.get(url)
    ...
    def test_encryption_detail_view_encrypted(self):
        ...
        url = reverse('horizon:admin:volumes:volumes:encryption_detail',
                      args=[volume.id])
        res = self.client.get(url)
    ...
    def test_update_volume(self):
        ...
        url = reverse('horizon:admin:volumes:volumes:update',
                      args=[volume.id])
        res = self.client.post(url, formData)
        self.assertRedirectsNoFollow(res, VOLUME_INDEX_URL)
    ...
    def test_upload_to_image(self):
        ...
        url = reverse('horizon:admin:volumes:volumes:upload_to_image',
                      args=[volume.id])
    ...
    def test_extend_volume(self):
        ...
        url = reverse('horizon:admin:volumes:volumes:extend',
                      args=[volume.id])
        res = self.client.post(url, formData)
    ...
    def test_retype_volume(self):
        ...
        url = reverse('horizon:admin:volumes:volumes:retype',
                      args=[volume.id])
        res = self.client.post(url, form_data)
    ...
    def test_create_transfer(self):
        ...
        url = reverse('horizon:admin:volumes:volumes:create_transfer',
    ...
    def test_accept_transfer(self):
        ...
        url = reverse('horizon:admin:volumes:volumes:accept_transfer')
        res = self.client.post(url, formData, follow=True)
        self.assertNoFormErrors(res)
    ...
    def test_download_transfer_credentials(self):
        ...
        url = reverse('horizon:admin:volumes:volumes:'
