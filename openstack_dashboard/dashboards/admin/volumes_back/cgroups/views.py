...
class CreateView(workflows.WorkflowView):
    ...
    template_name = 'admin/volumes/cgroups/create.html'
    page_title = _("Create Volume Consistency Group")


class UpdateView(forms.ModalFormView):
    template_name = 'admin/volumes/cgroups/update.html'
    ...
    submit_url = "horizon:admin:volumes:cgroups:update"
...
class RemoveVolumesView(forms.ModalFormView):
    template_name = 'admin/volumes/cgroups/remove_vols.html'
    modal_header = _("Remove Volumes from Consistency Group")
    form_class = vol_cgroup_forms.RemoveVolsForm
    success_url = reverse_lazy('horizon:admin:volumes:index')
    submit_url = "horizon:admin:volumes:cgroups:remove_volumes"
    submit_label = _("Submit")
    page_title = modal_header
...
class DeleteView(forms.ModalFormView):
    template_name = 'admin/volumes/cgroups/delete.html'
    modal_header = _("Delete Consistency Group")
    form_class = vol_cgroup_forms.DeleteForm
    success_url = reverse_lazy('horizon:admin:volumes:index')
    submit_url = "horizon:admin:volumes:cgroups:delete"
...
class CreateSnapshotView(forms.ModalFormView):
    ...
    template_name = 'admin/volumes/cgroups/create_snapshot.html'
    submit_label = _("Create Snapshot")
    submit_url = "horizon:admin:volumes:cgroups:create_snapshot"
    success_url = reverse_lazy('horizon:admin:volumes:cg_snapshots_tab')
    page_title = modal_header
...
class CloneCGroupView(forms.ModalFormView):
    ...
    template_name = 'admin/volumes/cgroups/clone_cgroup.html'
    submit_label = _("Clone Consistency Group")
    submit_url = "horizon:admin:volumes:cgroups:clone_cgroup"
    success_url = reverse_lazy('horizon:admin:volumes:cgroups_tab')
    page_title = modal_header
