...
VOLUME_CGROUPS_TAB_URL = urlunquote(reverse(
    'horizon:admin:volumes:cgroups_tab'))
VOLUME_CGROUPS_SNAP_TAB_URL = urlunquote(reverse(
    'horizon:admin:volumes:cg_snapshots_tab'))
...
class ConsistencyGroupTests(test.TestCase):
    ...
    def test_create_cgroup(self):
        ...
        url = reverse('horizon:admin:volumes:cgroups:create')
    ...
    def test_update_cgroup_add_vol(self):
        ...
        url = reverse('horizon:admin:volumes:cgroups:update',
                      args=[cgroup.id])
        res = self.client.post(url, formData)
        self.assertNoFormErrors(res)
        self.assertRedirectsNoFollow(res, VOLUME_INDEX_URL)
    ...
    def test_detail_view_with_exception(self):
        ...
        url = reverse('horizon:admin:volumes:cgroups:detail',
                      args=[cgroup.id])
    ...
    def test_create_snapshot(self):
        ...
        url = reverse('horizon:admin:volumes:cgroups:create_snapshot',
                      args=[cgroup.id])
        res = self.client.post(url, formData)
        self.assertNoFormErrors(res)
    ...
    def test_create_clone(self):
        ...
        url = reverse('horizon:admin:volumes:cgroups:clone_cgroup',
                      args=[cgroup.id])
        res = self.client.post(url, formData)
        self.assertNoFormErrors(res)
