...
from openstack_dashboard.dashboards.admin.user import forms as user_forms
...
class UserSettingsView(forms.ModalFormView):
    ...
    submit_label = _("Save")
    submit_url = reverse_lazy("horizon:admin:user:index")
    template_name = 'admin/user/settings.html'
