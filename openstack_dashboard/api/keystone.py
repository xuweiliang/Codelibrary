...
def send_mail(request, email, password):
    receivers = []
    sender ='from@runoob.com'
    user = request.POST.get('name', None)
    ipaddr = request.META.get('HTTP_ORIGIN',None)
    receivers.append(email)
    content =u"""\u5c0a\u656c\u7684\u7528\u6237{user}
             \u4e91\u684c\u9762\u7cfb\u7edf\u540e\u53f0IP\u4e3b\u673a{ipaddr}
             \u5bc6\u7801\u4fee\u6539\u4e3a:{password}
             \u5982\u6709\u7591\u95ee\u6216\u62d2\u7edd\u4fee\u6539\u8bf7\u8054\u7cfb\u7ba1\u7406\u5458 admin"""
    message = MIMEText(content.format(user=user, ipaddr=ipaddr, password=password), 'plain', 'utf-8')
    #message['From'] = Header(u'\u534e\u5b87\u8baf\u901a\u79d1\u6280', 'utf-8')
    message['From'] = Header(u'support@junesh.com', 'utf-8')
    message['To'] =  Header('', 'utf-8')
    subject = u'\u4e91\u684c\u9762\u7cfb\u7edf\u540e\u53f0\u4fee\u6539\u5bc6\u7801\u901a\u77e5'
...
def keystoneclient(request, admin=False):
    ...
    #LOG.info("api_version ====================%s" % api_version)
    user = request.user
...
def tenant_create(request, name, description=None, enabled=None,
                  domain=None, pool_type=None, **kwargs):
